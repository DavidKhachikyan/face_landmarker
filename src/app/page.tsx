...
export default function Home() {
  useEffect(() => {
    // Rest of your code that uses canvasCtx
    // const { FaceLandmarker, FilesetResolver, DrawingUtils } = vision;
    const demosSection: any = document.getElementById("demos");
...
********************************************************************/
    ...
    for (let imageContainer of imageContainers as any) {
...
********************************************************************/
  ...
  //     // Make sure the image is loaded before running detection
  //     (imageElement as any).onload = async () => {
